...
train_data=[$(pwd)/data/IC-Seg/train_6_448_448.parquet]
val_data=[$(pwd)/data/IC-Seg/train_6_448_448.parquet]
...
rlsd_lambda_decay_steps=${RLSD_LAMBDA_DECAY_STEPS:-100}
